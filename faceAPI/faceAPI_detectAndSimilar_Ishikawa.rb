...
f = File.binread("/Users/Ishikawa/Dropbox/faceAPI/pictures/" + ARGV[0] + ".jpg")
...
csv = CSV.open("/Users/Ishikawa/Dropbox/faceAPI/faceId_list.csv","r")
...
parse2.push(escapeHash)
    ...
    CSV.foreach("/Users/Ishikawa/Dropbox/faceAPI/faceId_list.csv") do|row|
